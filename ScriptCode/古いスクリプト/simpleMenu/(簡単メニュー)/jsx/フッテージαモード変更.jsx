...
*/
function setAlphaMode(tFtg,mode)
{
	if (tFtg.mainSource.hasAlpha==true){
		switch(mode){
			case 1: tFtg.mainSource.alphaMode=AlphaMode.IGNORE;break;
			case 2: tFtg.mainSource.alphaMode=AlphaMode.STRAIGHT;break;
			case 3: tFtg.mainSource.alphaMode=AlphaMode.PREMULTIPLIED;break;
		}
	}
}
//---------------------------------------------------------------------------
...
if ( (selectedItems!=null)&&(selectedItems.length>0) ) {
	...
	rbd.title="アルファーモード変更";
	rbd.caption1 = "無視";
	rbd.caption2 = "ストレート合成";
	rbd.caption3 = "マット合成";
	rbd.btnIndex = 1;
	if (rbd.execute()==true){
		for (var i = 0; i < selectedItems.length; i++) {
			if (selectedItems[i] instanceof FootageItem) {
				setAlphaMode(selectedItems[i],rbd.btnIndex);
